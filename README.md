...
To make things a bit more challenging, I didn't just feed the raw NO₂ data into the GAN. I transformed it using a unique sinusoidal function derived from my roll number (`102303496`). 
